...
This module provides GoogleDriveTools for downloading and managing
Google Drive documents within Agno agent workflows.

Requires: pip install google-workspace-tools[agno]
"""
